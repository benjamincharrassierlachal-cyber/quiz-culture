...
eq(E.progress(s).pausePenalty, 20, 'le coût de la pause est lisible en mode BAC');
var dpause = relaxGame();
eq(E.progress(dpause).pausePenalty, 20, 'le coût de la pause est lisible en mode détente');
eq(E.penalizePause(dpause).cost, 20, 'la pause coûte aussi en mode détente');
